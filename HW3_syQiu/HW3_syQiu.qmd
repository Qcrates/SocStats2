...
-   The naive estimate should be larger than the real estimate
...
-   With x
    ...
    The coefficient before x should be the direct effect, the coefficient before t should be the treatment effect.
